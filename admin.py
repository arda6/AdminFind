...
print(Fore.GREEN +"""
  ...
  8 8888888888 `8.`8888.      ,8' 8 8888         8 8888         
...
8 8888              8 8888      8 8888         8 8888         
  8 8888              8 8888      8 8888         8 8888         
8 888888888888      8 8888      8 888888888888 8 888888888888 
      ...
      """)
print("")
#MessageBox(None, 'EYLL Anka RED Team', 'EYLL', 0)
print(Fore.WHITE +"[?] Hedef Adres Girin")
site = input(Back.LIGHTGREEN_EX+"  root@eyll:~# ")
print("")
print(Fore.GREEN +"""
...
""")
e = input(Back.LIGHTGREEN_EX +"  root@eyll:~#")
a = -1
wr = open("eyll.txt","a")
if e == 'S':
  while True:
      a += 1
      print(Fore.YELLOW +"[?] Deneniyor : "+panel[a]+"")
      s = "{}".format(panel[a])
      try :
          r = requests.get(r""+site+""+s+"",timeout=1,headers={"User-Agent":"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36"})
          url = str(r.url)
          stat = str(r.status_code)
          conta = str(r.content)
          cont = conta.find("404")       
          if cont == -1:
            print(Fore.GREEN +"[+] Bulundu : "+url+" Durum Kodu : " +stat+"\n")
            wr.write("{}\n".format(url))
      except Exception:
  ...
  while True:
    ...
    try :
       ...
       asdhjbasdbasd = 0
#coded by eyLL https://www.github.com/arda6